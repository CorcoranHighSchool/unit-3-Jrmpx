...
//print("The value of foo is \(foo)")
//Because foo is decalred in the for loop is trying ot be accessed outside its scope
...
// x is decalred as global scope on line 14 and therfore can be accessed and modifed at any furuther restricting scope
